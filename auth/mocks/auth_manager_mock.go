...
func (m *MockAuthManager) GenerateResetPasswordToken(ctx context.Context, userID domain.UserID) (string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GenerateResetPasswordToken", ctx, userID)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockAuthManagerMockRecorder) GenerateResetPasswordToken(ctx, userID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GenerateResetPasswordToken", reflect.TypeOf((*MockAuthManager)(nil).GenerateResetPasswordToken), ctx, userID)
}

// GenerateVerificationCode mocks base method.
func (m *MockAuthManager) GenerateVerificationCode(ctx context.Context, key string) (string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GenerateVerificationCode", ctx, key)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockAuthManagerMockRecorder) GenerateVerificationCode(ctx, key any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GenerateVerificationCode", reflect.TypeOf((*MockAuthManager)(nil).GenerateVerificationCode), ctx, key)
}
