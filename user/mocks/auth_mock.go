...
func (m *MockAuthPort) ChangePassword(ctx context.Context, userID domain.UserID, newPassword, oldPassword string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ChangePassword", ctx, userID, newPassword, oldPassword)
	ret0, _ := ret[0].(error)
	return ret0
}

// ChangePassword indicates an expected call of ChangePassword.
func (mr *MockAuthPortMockRecorder) ChangePassword(ctx, userID, newPassword, oldPassword any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ChangePassword", reflect.TypeOf((*MockAuthPort)(nil).ChangePassword), ctx, userID, newPassword, oldPassword)
}
